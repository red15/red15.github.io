...
if [ -f "E:\Games\Unreal\Unreal Engine\4.11\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "E:\Games\Unreal\Unreal Engine\4.11\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
